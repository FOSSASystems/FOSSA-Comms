...
#define CMD_TRANSMIT_CALLSIGN_ALT_SF                    (0x02)
#define CMD_TRANSMIT_SYSTEM_INFO                        (0x03)
#define CMD_TRANSMIT_CALLSIGN_LOW_POWER                 (0x04)
#define CMD_GET_LAST_PACKET_INFO                        (0x05)
...
#define RESP_CALLSIGN_ALT_SF                            (CMD_TRANSMIT_CALLSIGN_ALT_SF + RESPONSE_OFFSET)
#define RESP_SYSTEM_INFO                                (CMD_TRANSMIT_SYSTEM_INFO + RESPONSE_OFFSET)
#define RESP_CALLSIGN_LOW_POWER                         (CMD_TRANSMIT_CALLSIGN_LOW_POWER + RESPONSE_OFFSET)
...
#define CMD_SET_MPPT_ENABLE                             (0x06 + PRIVATE_OFFSET)
#define CMD_SET_MPPT_MODE                               (0x07 + PRIVATE_OFFSET)
#define CMD_SET_LOW_POWER_ENABLE                        (0x08 + PRIVATE_OFFSET)
